...
public class SQLControlador {
    ...
    public void insertarDatos(String name, String profession) {
        ContentValues cv = new ContentValues();
        cv.put(DBhelper.MIEMBRO_NOMBRE, name);
        cv.put(DBhelper.MIEMBRO_PROFESION, profession);
    ...
    public int actualizarDatos(long memberID, String memberName, String memberProfession) {
        ContentValues cvActualizar = new ContentValues();
        cvActualizar.put(DBhelper.MIEMBRO_NOMBRE, memberName);
        cvActualizar.put(DBhelper.MIEMBRO_PROFESION, memberProfession);
